...
public interface LinkDao {
  ...
  @SqlQuery(
    ...
    "  and l.checked_at <= (now() - interval <interval> hour) " +
    "  and l.retry = <retry> " +
    "limit 100"
  )
  @UseRowMapper(LinkMapper.class)
  List<Link> findActiveLinks(@Define("retry") int retry, @Define("interval") int interval);
  ...
  @UseRowMapper(LinkMapper.class)
  List<Link> findFailedLinks(@Define("retry") int retry, @Define("interval") int interval);
